...
\textsc{Pos}$_\bot$ is the  same as the category \textsc{Pos} except that each poset has a least element $ \bot $. We construct its identity, composition, terminal object, product, exponential in the same way of \textsc{Pos}.\\
