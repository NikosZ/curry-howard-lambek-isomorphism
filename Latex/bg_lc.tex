...
\AxiomC{$ \Gamma \triangleright M: \tau $}
\RightLabel{($ \to $I)}
\UnaryInfC{$ \Gamma - x \tc \sigma \triangleright \lambda x \tc \sigma . M: \sigma \to \tau $}
\end{prooftree}
...
\RightLabel{($\to$I)}
\UnaryInfC{$ \triangleright \lambda x \tc \tau . x : \tau \to \tau $}
\RightLabel{($add$)}
\UnaryInfC{$ x \tc \sigma \triangleright \lambda x \tc \tau . x : \tau \to \tau $}
\RightLabel{($\to$I)}
\UnaryInfC{$ \triangleright \lambda x \tc \sigma. \lambda x \tc \tau . x : \sigma \to ( \tau \to \tau ) $}
\end{prooftree}
...
\RightLabel{($ \to $I)}
\UnaryInfC{$ x \tc \sigma \triangleright \lambda y \tc \tau . x: \tau \to \sigma $}
\RightLabel{($ \to $I)}
\UnaryInfC{$ \triangleright \lambda x \tc \sigma . \lambda y \tc \tau . x: \sigma \to \tau \to \sigma $}
\end{prooftree}
